    ...
    <footer className="bg-navy text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <Link href="/" className="inline-block mb-4">
              ...
              <img src={LOGO_DATA_URL} alt="Arc Electrical & Gas (Leeds) Ltd" height={60} className="h-12 w-auto" />
            </Link>
            ...
            <div className="space-y-2.5">
              ...
              <a href="tel:01132866140" className="flex items-center gap-2 text-blue-200 hover:text-white text-sm transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" /></svg>
                0113 286 6140
              </a>
              <a href="mailto:chris@arcelectricalandgas.co.uk" className="flex items-center gap-2 text-blue-200 hover:text-white text-sm transition-colors">
          ...
          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-blue-200">Services</h3>
            <ul className="space-y-2">
              {services.map(s => <li key={s.name}><Link href={s.href} className="text-blue-200 hover:text-white text-sm transition-colors">{s.name}</Link></li>)}
            </ul>
          </div>

          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-blue-200">Service Areas</h3>
            <ul className="space-y-2">
              {locs.map(l => <li key={l.name}><Link href={l.href} className="text-blue-200 hover:text-white text-sm transition-colors">{l.name}</Link></li>)}
            </ul>
          </div>

          <div>
            <h3 className="font-semibold text-sm uppercase tracking-wider mb-4 text-blue-200">Company</h3>
            ...
            <div className="mt-5 pt-5 border-t border-white/20">
              <p className="text-xs text-blue-300 leading-relaxed">NAPIT Approved &middot; Part P Accredited<br/>Gas Safe Registered &middot; Worcester Bosch Accredited</p>
            </div>
          </div>
        </div>
      </div>
      <div className="border-t border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-2">
          <p className="text-blue-300 text-xs">&copy; {new Date().getFullYear()} Arc Electrical And Gas (Leeds) Ltd. All rights reserved.</p>
          <Link href="/contact" className="text-blue-300 hover:text-white text-xs transition-colors">Contact Us</Link>
        </div>
      </div>
    </footer>
  )
