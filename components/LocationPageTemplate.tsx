      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/areas-we-cover" className="inline-block bg-orange-50 hover:bg-orange-500 hover:text-white text-orange-600 font-medium px-4 py-2 rounded-lg transition-colors text-sm">View All Areas &rarr;</Link>
          </div>
        </div>
      </section>
