...
const primaryAreas = [
  ...
  { name: 'Sherburn in Elmet', desc: 'Market town in North Yorkshire, south-east of Leeds, LS25 area.', electricHref: '/areas-we-cover', gasHref: '/areas-we-cover' },
...
const secondaryAreas = [
  'Great Preston', 'Swillington', 'Rothwell', 'Cross Gates', 'Selby',
]
    ...
    <>
      <section className="bg-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">ARC Electrical &amp; Gas provide electrical and gas services across Kippax, Garforth, Allerton Bywater, Micklefield, Sherburn in Elmet, South Milford, Castleford, Fairburn and surrounding areas.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {primaryAreas.map(area => (
              <div key={area.name} className="bg-gray-50 rounded-2xl p-7 border border-gray-100">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href={area.electricHref} className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded-lg transition-colors text-sm">
          ...
          <p className="text-gray-600">Not sure if we cover your area? Call us on <a href="tel:07810413488" className="text-gray-900 font-semibold hover:underline">07810 413488</a> and we&apos;ll let you know.</p>
          ...
          <div className="mt-10 bg-gray-50 border border-gray-100 rounded-2xl p-6">
            ...
            <p className="text-gray-600">Monday &#8211; Friday: <strong>8am &#8211; 5pm</strong></p>
          </div>
        </div>
      </section>
