...
const services = [
  ...
  { name: 'Boiler Repairs', desc: 'Diagnosing and repairing faults on all major boiler brands using genuine parts. We identify the issue quickly and carry out the repair safely.', icon: '🛠️' },
  ...
  { name: 'Replacement Radiators & Small Plumbing Repairs', desc: 'Radiator replacements and minor plumbing repairs carried out by our Gas Safe registered engineers. Supply and fit or fit only.', icon: '🔧' },
  { name: 'Appliance Servicing', desc: 'Servicing of gas fires, stoves, water heaters, cookers and hobs to manufacturer’s instructions by Gas Safe registered engineers.', icon: '🍳' },
]
...
const faqs = [
  ...
  { question: 'Do you use genuine parts for repairs?', answer: 'Yes. We only use genuine parts on all boiler repairs and gas work. This ensures the repair is safe, reliable and maintains your boiler warranty where applicable.' },
  { question: 'Can you replace radiators and do small plumbing repairs?', answer: 'Yes. We carry out radiator replacements and minor plumbing repairs. All plumbing work is carried out by our Gas Safe registered engineers to the same high standards as our gas work.' },
]
      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">Gas Safe registered engineers serving Kippax, Garforth, Allerton Bywater, Sherburn in Elmet, Castleford and surrounding areas. Boiler servicing, repairs, installations, radiator replacements and landlord gas safety records.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                {services.map(s => (
                  <div key={s.name} className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <h3 className="font-bold text-gray-900 mb-1 text-sm">
                      {s.href ? <Link href={s.href} className="hover:text-gray-600">{s.name}</Link> : s.name}
                    </h3>
            ...
            <div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
                ...
                <p className="text-gray-600 text-sm">We are accredited Worcester Bosch installers. Extended warranties are available when we fit a Worcester Bosch boiler. Genuine parts used on all repairs.</p>
              </div>
            </div>
          </div>
        </div>
