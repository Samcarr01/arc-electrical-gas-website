...
const faqs = [
  ...
  { question: 'Is an EICR a legal requirement?', answer: 'Yes, for rental properties in England. Since July 2020, landlords must have an EICR carried out every 5 years and provide a copy to their tenants. For owner-occupied homes, an EICR is strongly recommended but not currently a legal requirement.' },
  { question: 'How long does an EICR take?', answer: 'A standard domestic EICR typically takes 2–4 hours depending on the size of the property and the condition of the installation. Older properties or larger homes may take longer.' },
  { question: 'What happens if the EICR finds problems?', answer: 'The report will classify any issues as C1 (danger present, immediate action required), C2 (potentially dangerous, urgent attention recommended) or C3 (improvement recommended). Any C1 or C2 codes mean the installation requires remedial work before it is considered satisfactory.' },
  { question: 'Do you carry out remedial work after the EICR?', answer: 'Yes. If the EICR identifies any C1 or C2 issues, we can carry out the remedial electrical work to bring the installation up to standard, and then re-certify.' },
  { question: 'What areas do you cover for EICR testing?', answer: 'We cover Kippax, Garforth, Allerton Bywater, Micklefield, Great Preston, Swillington, Rothwell, Cross Gates, Castleford, Sherburn in Elmet and surrounding areas.' },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-5">
              ...
              <span className="text-orange-400">EICR Testing</span>
            </nav>
            <h1 className="text-4xl md:text-5xl font-bold mb-5">EICR Testing</h1>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">Electrical Installation Condition Reports for homeowners and landlords across Kippax, Garforth, Allerton Bywater, Micklefield and the wider Leeds area. NAPIT & Part P accredited. Full report issued on completion.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-3">
                {['Every 5 years for private rental properties (legal requirement since 2020)','When buying or selling a property','If the property is over 25 years old and has never been inspected','After major flooding or fire damage','When extending or renovating a property','For landlord compliance and insurance purposes'].map(i => (
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  {['Consumer unit / fuse board inspection','Wiring condition and age assessment','Socket and switch testing','RCD testing','Earthing and bonding checks','Visual inspection of all accessible fixed wiring','Full written report with any recommendations'].map(i => (
