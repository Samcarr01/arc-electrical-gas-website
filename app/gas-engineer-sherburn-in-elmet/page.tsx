...
export default function GasEngineerSherburnInElmetPage() {
  return (
    <LocationPageTemplate
      ...
      intro="ARC Electrical & Gas is a Gas Safe registered engineer providing boiler servicing, repairs and installations throughout Sherburn in Elmet and the surrounding LS25 area. Worcester Bosch accredited with over 30 years of experience, we look after homes across this West Yorkshire market town and nearby villages. All gas work is fully insured and an electronic record is issued on completion."
      services={[
