...
export default function GasEngineerFairburnPage() {
  return (
    <LocationPageTemplate
      ...
      intro="ARC Electrical & Gas are Gas Safe registered, Worcester Bosch accredited engineers covering Fairburn and the nearby area around Castleford. We provide boiler servicing, repairs and installations for local homes. All gas work is fully insured and an electronic record is issued on completion."
      services={[
      ...
      faqs={[
        { question: 'Are you Gas Safe registered to work in Fairburn?', answer: 'Yes. We are Gas Safe registered (Reg. No. 584102). All our gas engineers are fully qualified and registered, and you can verify our registration at gassaferegister.co.uk.' },
