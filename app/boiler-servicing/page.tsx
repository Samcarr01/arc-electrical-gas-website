...
const checks = ['Test carried out on gas meter and pipe work to check for leaks','Inspection of flue and chimney for correct operation','Condition check of appliance — seals, gaskets and heat distress','Service completed to appliance-specific manufacturer’s instructions','Combustion gas analysis to ensure safe and efficient burning','Electronic service record issued on completion']
...
const faqs = [
  ...
  { question: 'What is the difference between a service and a repair?', answer: 'A service is a routine maintenance check carried out on a working boiler to keep it safe and efficient. A repair is when the boiler has developed a fault or stopped working and needs a component to be diagnosed and fixed.' },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-5">
              ...
              <span className="text-orange-400">Boiler Servicing</span>
            </nav>
            <h1 className="text-4xl md:text-5xl font-bold mb-5">Boiler Servicing</h1>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">Annual boiler servicing by Gas Safe registered, Worcester Bosch accredited engineers. Serving Kippax, Garforth, Allerton Bywater, Micklefield and surrounding areas. Electronic service record provided on completion.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-6">Our Gas Safe registered engineers carry out a thorough boiler service to manufacturer’s instructions. On completion, an electronic service record is issued and can be emailed to you.</p>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
                ...
                <ul className="space-y-2 text-sm">
                  {['Boiler repairs and fault diagnosis','New boiler installation','Gas Safety Records for landlords (CP12)','Gas fire servicing','Appliance servicing — cookers, water heaters, stoves'].map(i => (
