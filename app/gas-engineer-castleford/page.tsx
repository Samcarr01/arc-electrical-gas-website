...
export default function GasEngineerCastlefordPage() {
  return (
    <LocationPageTemplate
      ...
      faqs={[
        { question: 'Are you Gas Safe registered to work in Castleford?', answer: 'Yes. We are Gas Safe registered (Reg. No. 584102). All our gas engineers are fully qualified and registered, and you can verify our registration at gassaferegister.co.uk.' },
