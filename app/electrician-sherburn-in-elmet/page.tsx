...
export const metadata: Metadata = {
  ...
  description: 'Looking for an electrician in Sherburn in Elmet? ARC Electrical & Gas are NAPIT & Part P accredited with 30+ years experience. EICR, fuse boards, sockets, lighting and more. Call 07810 413488.',
...
export default function ElectricianSherburnInElmetPage() {
  return (
    <LocationPageTemplate
      ...
      intro="ARC Electrical & Gas provide professional electrical services throughout Sherburn in Elmet and the surrounding LS25 area. We are NAPIT approved and Part P accredited, with over 30 years of experience serving homes and businesses across this West Yorkshire market town. All work is fully insured and certified on completion."
      services={[
