...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gas Engineer in Garforth | ARC Electrical & Gas',
    description: 'Gas Safe registered engineer in Garforth. Boiler servicing, repairs, new boilers and CP12 certificates. Call 07810 413488.',
    url: '/gas-engineer-garforth',
  },
  twitter: {
    title: 'Gas Engineer in Garforth | ARC Electrical & Gas',
    description: 'Gas Safe registered engineer in Garforth. Boiler servicing, repairs, new boilers and CP12 certificates. Call 07810 413488.',
...
export default function GasEngineerGarforthPage() {
  return (
    <LocationPageTemplate
      ...
      intro="ARC Electrical & Gas is a Gas Safe registered engineer providing boiler servicing, repairs, installations and gas safety records throughout Garforth and the LS25 area. Worcester Bosch accredited installers with over 30 years of experience. Electronic records provided on all gas work."
      services={[
