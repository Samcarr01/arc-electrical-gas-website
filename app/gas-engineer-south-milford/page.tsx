...
export default function GasEngineerSouthMilfordPage() {
  return (
    <LocationPageTemplate
      ...
      intro="ARC Electrical & Gas are Gas Safe registered, Worcester Bosch accredited engineers covering South Milford and the surrounding LS25 area. We provide boiler servicing, repairs and installations for homes in the village between Sherburn in Elmet and Selby. All gas work is fully insured and an electronic record is issued on completion."
      services={[
      ...
      faqs={[
        { question: 'Are you Gas Safe registered to work in South Milford?', answer: 'Yes. We are Gas Safe registered (Reg. No. 584102). All our gas engineers are fully qualified and registered, and you can verify our registration at gassaferegister.co.uk.' },
