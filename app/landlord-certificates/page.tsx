...
const faqs = [
  ...
  { question: 'How long does an EICR take for a rental property?', answer: 'A standard 2–3 bedroom rental property typically takes 2–4 hours. Larger properties may take longer.' },
  ...
  { question: 'Do you carry out any remedial work needed?', answer: 'Yes. If the EICR identifies any C1 or C2 issues, we can carry out the remedial work and re-certify. For gas work, we can carry out any repairs or replacements required.' },
  { question: 'Can you manage multiple properties?', answer: 'Yes. We work with landlords managing multiple rental properties and can coordinate visits and issue all certificates efficiently.' },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <nav className="flex items-center gap-2 text-sm text-blue-200 mb-5">
              ...
              <span className="text-yellow-400">Landlord Certificates</span>
            </nav>
            <h1 className="text-4xl md:text-5xl font-bold mb-5">Landlord Electrical &amp; Gas Certificates</h1>
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">EICR reports and Gas Safety Records (CP12) for landlords across Kippax, Garforth, Allerton Bywater, Micklefield and the wider Leeds area. All certificates emailed to you or your letting agent.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-gray-600 mb-4 text-sm">Required every 5 years for private rental properties. Mandatory since July 2020.</p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-gray-600 mb-4 text-sm">Required every 12 months for properties with gas appliances. Mandatory for all landlords with gas.</p>
              <ul className="space-y-2 text-sm text-gray-600 mb-6">
